...
`discord-tsx-factory` is compatible with `discord.js` version `14.7.0 - 14.8.0`. (See `peerDependencies`)
...
```bash
$ npm install --save discord.js@14.8.0 discord-tsx-factory
```

Using yarn

```bash
$ yarn add discord.js@14.8.0 discord-tsx-factory
```

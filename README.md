...
`discord-tsx-factory` is compatible with `discord.js` version `14.10.0 - 14.10.2`. (See `peerDependencies`)
...
```bash
$ npm install --save discord.js@14.10.2 discord-tsx-factory
```

Using yarn

```bash
$ yarn add discord.js@14.10.2 discord-tsx-factory
```
